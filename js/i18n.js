...
window.I18N = {
  tr: {
    ...
    ob: {
      ...
      card3a:'😴 "Bebeğim Uyudu" butonuna bas', card3b:'🎙 Ağlama veya kolik dedektörünü seç', card3c:'📊 Uygulama gece boyu izler ve rapor tutar', card3d:'🌅 Sabah "Bebeğim Uyandı" ile gece özeti gelir',
  ...
  en: {
    ...
    ob: {
      ...
      card3a:'😴 Tap "My Baby Slept" button', card3b:'🎙 Choose cry or colic detector', card3c:'📊 App monitors all night and saves report', card3d:'🌅 Tap "My Baby Woke Up" for morning summary',
