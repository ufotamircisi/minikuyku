...
window.I18N = {
  tr: {
    ...
    upgradeBtn: 'Yükselt',
    premiumTitle: 'Minik Uyku Premium',
    premiumSub: '3 günlük denemeden sonra premium ile devam edin',
    premiumF1: 'Sınırsız ninni dinleme',       premiumF1s: 'Deneme sonrası premium ile devam eder',
    premiumF2: 'Tüm masallar ve hikayeler',    premiumF2s: 'Türkçe ve English içerikler',
    premiumF3: 'Gelişmiş dedektörler',         premiumF3s: 'Ağlama ve kolik araçları',
    premiumF4: 'Detaylı uyku analizi',         premiumF4s: 'Rutin ve tahmin görünümü',
    premiumF5: 'Ses klonlama desteği',         premiumF5s: 'Yayın öncesi backend ile bağlanmalı',
  ...
  en: {
    ...
    upgradeBtn: 'Upgrade',
    premiumTitle: 'Minik Uyku Premium',
    premiumSub: 'Continue with premium after the 3-day trial',
    premiumF1: 'Unlimited lullabies',          premiumF1s: 'Continue with premium after trial',
    premiumF2: 'All stories',                  premiumF2s: 'Turkish and English content',
    premiumF3: 'Advanced detectors',           premiumF3s: 'Cry and colic tools',
    premiumF4: 'Sleep analysis',               premiumF4s: 'Routine and prediction view',
    premiumF5: 'Voice cloning support',        premiumF5s: 'Connect a backend before release',
