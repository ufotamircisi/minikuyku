...
window.I18N = {
  tr: {
    ...
    premiumF1: 'Sınırsız Ninni & Hikaye',       premiumF1s: '1 dakika önizleme sınırı kalkar',
    premiumF2: 'Ağlama & Kolik Dedektörü',    premiumF2s: 'Otomatik ninni ve beyaz gürültü başlatır',
    premiumF3: 'Ağlama Analizi',         premiumF3s: '10 saniye dinleyip olasılık gösterir',
    premiumF4: 'Ses Klonlama',         premiumF4s: 'Kendi sesinizle ninni ve hikaye',
  ...
  en: {
    ...
    premiumF1: 'Unlimited Lullabies & Stories',          premiumF1s: '1 minute preview limit removed',
    premiumF2: 'Cry & Colic Detector',                  premiumF2s: 'Auto-starts lullaby or white noise',
    premiumF3: 'Cry Analysis',           premiumF3s: 'Shows probability in 10 seconds',
    premiumF4: 'Voice Cloning',               premiumF4s: 'Lullabies and stories in your voice',
